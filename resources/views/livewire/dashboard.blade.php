...
@section('content')
    <div>
                        ...
                        <div class="tab nav-border" style="position: relative;">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active show" id="months" role="tabpanel"
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/05.jpg') }}"
                                                alt="">
                                        </div>
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/02.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/03.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/04.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                ...
                                <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/09.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/06.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/07.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid" src="{{ asset('assets/images/blog/08.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
        ...
        <div class="row">
                        ...
                        <ul class="list-unstyled">
                                ...
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('assets/images/item/01.png') }}" alt="">
                                    </div>
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('assets/images/item/02.png') }}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('assets/images/item/03.png') }}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('assets/images/item/04.png') }}" alt="">
                                    </div>
                                    <div class="media-body">
            ...
            <div class="col-xl-4 mb-30">
                <div class="card card-statistics h-100">
                    <div class="p-4 text-center bg" style="background: url({{ asset('assets/images/bg/01.jpg') }});">
                    ...
                    <div class="card-body text-center position-relative">
                        <div class="avatar-top">
                            <img class="img-fluid w-25 rounded-circle " src="{{ asset('assets/images/team/13.jpg') }}"
                                alt="">
                        </div>
                        <div class="row">
